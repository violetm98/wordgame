...
public class GameSessionViewModel extends AndroidViewModel {
    ...
    public void insertGameStats(GameStats gameStats){
        repository.insertGameStats(gameStats);
    }

    public void insertWordStats(WordStats wordStats) {repository.insertWordStats(wordStats);}

    public void updateWordStats(WordStats wordStats) {repository.updateWordStats(wordStats);}
